...
namespace COMP003B.Assignment6.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public PlayersController(SoccerTeamContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PlayerId,Name,Position,JerseyNumber,Age")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlayerId,Name,Position,JerseyNumber,Age")] Player player)
        {
